                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion" style="background-color: #3E5879;">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="pelanggan3.php">
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">SELAMAT DATANG [ SPG ]</li>
                        </ol>
                        <div class="row" >
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$jumlah;?></td>
                                            <td>
                                                <a href="view3.php?idp=<?=$idorder;?>" class="btn" target="blank" style="background-color: #8EACCD;">Tampilkan</a>
                                                <button type="button" class="btn" data-toggle="modal" data-target="#delete<?=$idorder;?>" style="background-color: #C96868;">
                                                    Delete
                                                </button>
                                            </td>
                                        </tr>
                                         ...
                                         <div class="modal fade" id="delete<?=$idorder;?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <button type="submit" class="btn" name="hapusorder"  style="background-color: #79B57D;">Ya</button>
...
<div class="modal fade" id="myModal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal footer -->
        <div class="modal-footer">
          <button type="submit" class="btn" name="tambahpesanan" style="background-color: #79B57D;">Submit</button>
          <button type="button" class="btn" data-dismiss="modal" style="background-color: #C96868;">Close</button>
        </div>
