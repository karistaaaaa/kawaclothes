                                ...
                                <table id="datatablesSimple">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn" data-toggle="modal" data-target="#edit<?=$idpr;?>" style="background-color: #FADFA1;">
                                                    Edit
                                                </button> 
                                        ...
                                        <div class="modal fade" id="delete<?=$idpr;?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <!-- Modal footer -->
                                                <div class="modal-footer">
                                                <button type="submit" class="btn" name="hapusprodukpesanan" style="background-color: #79B57D;">Ya</button>
                                                <button type="button" class="btn" data-dismiss="modal" style="background-color: #C96868;">Close</button>
                                                </div>
...
<div class="modal fade" id="myModal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal footer -->
        <div class="modal-footer">
          <button type="submit" class="btn" name="addprodukadmin" style="background-color: #79B57D;">Submit</button>
          <button type="button" class="btn" data-dismiss="modal" style="background-color: #C96868;">Close</button>
        </div>
