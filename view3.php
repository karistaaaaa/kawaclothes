...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark" style="background-color: #3E5879;">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index3.php">Cashier App</a>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <button type="button" class="btn" data-toggle="modal" data-target="#editdetailpesanan3<?=$idpr;?>" style="background-color: #FADFA1;">
                                                    Edit
                                                </button> 
                                         ...
                                         <!-- Modal Edit -->
                                         <div class="modal fade" id="editdetailpesanan3<?=$idpr;?>">
                                        ...
                                        <div class="modal fade" id="delete<?=$idpr;?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <!-- Modal footer -->
                                                <div class="modal-footer">
                                                <button type="submit" class="btn" name="hapusprodukpesanan3" style="background-color: #79B57D;">Ya</button>
                                                <button type="button" class="btn" data-dismiss="modal" style="background-color: #C96868;">Close</button>
                                                </div>
