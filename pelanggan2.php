                                    ...
                                    ?>
                                        ...
                                        <div class="modal fade" id="edit<?=$idpl;?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <button type="submit" class="btn" name="editpelanggan2" style="background-color: #79B57D;">Submit</button>
  ...
  <div class="modal fade" id="myModal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal footer -->
        <div class="modal-footer">
          <button type="submit" class="btn" name="tambahpelanggan2" style="background-color: #79B57D;">Submit</button>
          <button type="button" class="btn" data-dismiss="modal" style="background-color: #C96868;">Close</button>
        </div>
